...
from core/648core.py import *

def main():
	banner()
	print " \033[1;32;40m 《01》 Information Gathering \n"
	...
	if 648 == "1" or 648 == "01":
		...
		if webhack == "01" or webhack == "1":
			...
			inther()
		elif webhack == "B" or webhack == "B	":
			restart_program()
		else:
			print "\nERROR: Wrong Input"
			timeout(2)
			restart_program()
	elif 648 == "6" or 648 == "06":
		print "\n    《01》 Metasploit"
		print "    《02》 commix"
		print "    《03》 sqlmap"
		print "    《04》 Brutal"
