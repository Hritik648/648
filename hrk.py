...
def incompletedsian_wordlist():
	print '\n》》》》》》 Installing incompletedsian-wordlist 》》》》》》'
	os.system('apt update && apt upgrade')
	os.system('apt install git')
	os.system('git clone https://github.com/geovedi/incompletedsian-wordlist')
	os.system('mv incompletedsian-wordlist ~')
	print '》》》》》》 completed 》》》》》》'
	backtomenu_option()
